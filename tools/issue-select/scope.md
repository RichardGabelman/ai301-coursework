...
I have a Bachelor's of Science in Computer Science. I have an interest in civic tech and related subjects (government, public policy, land use, social studies). I have experience building stuff in JavaScript, TypeScript, and Python, specifically using React, Express, and FastAPI. I'm also comfortable with PostgreSQL (and Prisma). I've dabbled a bit with CI/CD (specifically GitHub actions) and Docker. Non-hands on understanding of Java, C/C++, and C#. I like both frontend and backend.
